...
/**
 * This class filters a list of properties by their type(House).
 */
public class HouseFilter implements Filtro{
    /**
     * Method used to filter house.
     *
    ...
    public List<Announcement> typeFilter(List<Announcement> properties) {
        ...
        for (Announcement property : properties) {
            if(property.getRequest().getProperty().getTypeOfProperty() == Property.TypeOfProperty.HOUSE){
                type.add(property);
            }
        }
        return type;
